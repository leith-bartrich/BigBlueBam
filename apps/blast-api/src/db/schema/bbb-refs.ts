...
// Minimal stubs for Bam tables referenced by Blast
// These mirror the existing Bam schema but are defined here so
// blast-api can reference them without importing from @bigbluebam/api.
...
// Bond contacts stub (referenced by blast_send_log and engagement events)
