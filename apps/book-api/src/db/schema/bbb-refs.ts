...
// Minimal stubs for Bam tables referenced by Book
// These mirror the existing Bam schema but are defined here so
// book-api can reference them without importing from @bigbluebam/api.
...
// Projects stub (referenced by calendars and booking pages)
