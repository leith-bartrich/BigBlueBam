...
export function BearingLayout({ children, onNavigate, activeRoute }: BearingLayoutProps) {
    ...
    <div className="flex flex-col h-screen overflow-hidden bg-zinc-50 dark:bg-zinc-950">
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-[260px] flex-shrink-0 bg-sidebar flex flex-col">
          <BearingSidebar onNavigate={onNavigate} activePage={activeRoute.page} />
        </aside>
      ...
      <Launchpad isOpen={launchpadOpen} onClose={() => setLaunchpadOpen(false)} currentApp="bearing" />
    </div>
  );
}
