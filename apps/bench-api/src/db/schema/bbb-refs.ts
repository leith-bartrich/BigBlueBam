...
// Minimal stubs for Bam tables referenced by Bench
// These mirror the existing Bam schema but are defined here so
// bench-api can reference them without importing from @bigbluebam/api.
...
export const projects = pgTable(
  ...
  (table) => [index('projects_org_id_idx').on(table.org_id)],
);
