...
export function getAvailableActions(): { tool: string; description: string; source: string }[] {
  return [
    ...
    { tool: 'create_task', description: 'Create a new task in a project', source: 'bam' },
    { tool: 'update_task', description: 'Update task fields (title, description, assignee, priority, due_date, labels, phase)', source: 'bam' },
    { tool: 'move_task', description: 'Move task to a different phase or position', source: 'bam' },
    { tool: 'delete_task', description: 'Delete a task', source: 'bam' },
    { tool: 'bulk_update_tasks', description: 'Bulk-update multiple tasks in one operation', source: 'bam' },
    { tool: 'duplicate_task', description: 'Duplicate an existing task', source: 'bam' },
    { tool: 'log_time', description: 'Log a time entry against a task', source: 'bam' },
    { tool: 'add_comment', description: 'Add a comment to a task', source: 'bam' },
    { tool: 'create_sprint', description: 'Create a new sprint in a project', source: 'bam' },
    { tool: 'start_sprint', description: 'Start (activate) a sprint', source: 'bam' },
    { tool: 'complete_sprint', description: 'Complete (close) a sprint', source: 'bam' },
    { tool: 'create_project', description: 'Create a new project', source: 'bam' },

    // -------- Banter (chat, calls) --------
    { tool: 'banter_post_message', description: 'Post a message to a channel', source: 'banter' },
    { tool: 'banter_send_dm', description: 'Send a direct message to a user', source: 'banter' },
    { tool: 'banter_send_group_dm', description: 'Send a group direct message to multiple users', source: 'banter' },
    { tool: 'banter_create_channel', description: 'Create a new channel', source: 'banter' },
    { tool: 'banter_archive_channel', description: 'Archive a channel', source: 'banter' },
    { tool: 'banter_add_channel_members', description: 'Add members to a channel', source: 'banter' },
    { tool: 'banter_react', description: 'Add an emoji reaction to a message', source: 'banter' },
    { tool: 'banter_pin_message', description: 'Pin a message in a channel', source: 'banter' },
    { tool: 'banter_share_task', description: 'Share a Bam task as a message in a channel', source: 'banter' },
    { tool: 'banter_share_sprint', description: 'Share a Bam sprint as a message in a channel', source: 'banter' },
    { tool: 'banter_share_ticket', description: 'Share a Helpdesk ticket as a message in a channel', source: 'banter' },
    { tool: 'banter_start_call', description: 'Start a voice/video call in a channel', source: 'banter' },
    { tool: 'banter_end_call', description: 'End an active call', source: 'banter' },
    { tool: 'banter_invite_agent_to_call', description: 'Invite an AI agent to join a live call', source: 'banter' },

    // -------- Beacon (knowledge base) --------
    { tool: 'beacon_create', description: 'Create a new knowledge beacon entry', source: 'beacon' },
    { tool: 'beacon_update', description: 'Update a beacon entry', source: 'beacon' },
    { tool: 'beacon_publish', description: 'Publish a beacon entry', source: 'beacon' },
    { tool: 'beacon_verify', description: 'Mark a beacon as verified', source: 'beacon' },
    { tool: 'beacon_challenge', description: 'Challenge a beacon for review', source: 'beacon' },
    { tool: 'beacon_retire', description: 'Retire a beacon entry', source: 'beacon' },
    { tool: 'beacon_restore', description: 'Restore a retired beacon entry', source: 'beacon' },
    { tool: 'beacon_tag_add', description: 'Add a tag to a beacon entry', source: 'beacon' },
    { tool: 'beacon_tag_remove', description: 'Remove a tag from a beacon entry', source: 'beacon' },
    { tool: 'beacon_link_create', description: 'Create a link between two beacons', source: 'beacon' },
    { tool: 'beacon_link_remove', description: 'Remove a link between two beacons', source: 'beacon' },
    { tool: 'beacon_policy_set', description: 'Set access policy for a beacon', source: 'beacon' },

    // -------- Brief (documents) --------
    { tool: 'brief_create', description: 'Create a new Brief document', source: 'brief' },
    { tool: 'brief_update', description: 'Update Brief document metadata (title, status, etc.)', source: 'brief' },
    { tool: 'brief_update_content', description: 'Replace the body content of a Brief document', source: 'brief' },
    { tool: 'brief_append_content', description: 'Append content to an existing Brief document', source: 'brief' },
    { tool: 'brief_archive', description: 'Archive a Brief document', source: 'brief' },
    { tool: 'brief_restore', description: 'Restore an archived Brief document', source: 'brief' },
    { tool: 'brief_duplicate', description: 'Duplicate a Brief document', source: 'brief' },
    { tool: 'brief_promote_to_beacon', description: 'Promote a Brief document into a Beacon entry', source: 'brief' },
    { tool: 'brief_link_task', description: 'Link a Brief document to a Bam task', source: 'brief' },
    { tool: 'brief_comment_add', description: 'Add a comment to a Brief document', source: 'brief' },
    { tool: 'brief_comment_resolve', description: 'Resolve a comment thread on a Brief document', source: 'brief' },
    { tool: 'brief_version_restore', description: 'Restore a Brief document to a previous version', source: 'brief' },

    // -------- Helpdesk --------
    { tool: 'reply_to_ticket', description: 'Add a reply to a helpdesk ticket', source: 'helpdesk' },
    { tool: 'update_ticket_status', description: 'Update the status of a helpdesk ticket', source: 'helpdesk' },
    { tool: 'helpdesk_update_settings', description: 'Update helpdesk workflow settings for the organization', source: 'helpdesk' },

    // -------- Bond (CRM) --------
    { tool: 'bond_create_contact', description: 'Create a new contact in the CRM', source: 'bond' },
    { tool: 'bond_update_contact', description: 'Update an existing contact', source: 'bond' },
    { tool: 'bond_merge_contacts', description: 'Merge two contact records', source: 'bond' },
    { tool: 'bond_create_company', description: 'Create a new company record', source: 'bond' },
    { tool: 'bond_update_company', description: 'Update an existing company record', source: 'bond' },
    { tool: 'bond_create_deal', description: 'Create a new deal in the pipeline', source: 'bond' },
    { tool: 'bond_update_deal', description: 'Update an existing deal', source: 'bond' },
    { tool: 'bond_move_deal_stage', description: 'Move a deal to a different pipeline stage', source: 'bond' },
    { tool: 'bond_close_deal_won', description: 'Close a deal as won', source: 'bond' },
    { tool: 'bond_close_deal_lost', description: 'Close a deal as lost', source: 'bond' },
    { tool: 'bond_log_activity', description: 'Log an activity (call, email, meeting, note) against a contact or deal', source: 'bond' },
    { tool: 'bond_score_lead', description: 'Compute a lead score for a contact or deal', source: 'bond' },

    // -------- Blast (email campaigns) --------
    { tool: 'blast_create_template', description: 'Create a new email template', source: 'blast' },
    { tool: 'blast_draft_campaign', description: 'Draft a new email campaign', source: 'blast' },
    { tool: 'blast_send_campaign', description: 'Send a drafted email campaign to its recipients', source: 'blast' },
    { tool: 'blast_create_segment', description: 'Create a new recipient segment', source: 'blast' },
    { tool: 'blast_draft_email_content', description: 'AI-draft the HTML body for an email campaign', source: 'blast' },

    // -------- Board (whiteboards) --------
    { tool: 'board_create', description: 'Create a new whiteboard', source: 'board' },
    { tool: 'board_update', description: 'Update whiteboard metadata (name, description)', source: 'board' },
    { tool: 'board_archive', description: 'Archive a whiteboard', source: 'board' },
    { tool: 'board_add_sticky', description: 'Add a sticky note to a whiteboard', source: 'board' },
    { tool: 'board_add_text', description: 'Add a text element to a whiteboard', source: 'board' },
    { tool: 'board_promote_to_tasks', description: 'Promote whiteboard stickies into Bam tasks', source: 'board' },
    { tool: 'board_export', description: 'Export a whiteboard as an image or PDF', source: 'board' },

    // -------- Bearing (goals & OKRs) --------
    { tool: 'bearing_goal_create', description: 'Create a new goal', source: 'bearing' },
    { tool: 'bearing_goal_update', description: 'Update an existing goal', source: 'bearing' },
    { tool: 'bearing_kr_create', description: 'Create a new key result on a goal', source: 'bearing' },
    { tool: 'bearing_kr_update', description: 'Update a key result (including progress)', source: 'bearing' },
    { tool: 'bearing_kr_link', description: 'Link a key result to another entity (task, beacon, etc.)', source: 'bearing' },
    { tool: 'bearing_update_post', description: 'Post a status update against a goal or KR', source: 'bearing' },

    // -------- Bill (invoicing) --------
    { tool: 'bill_create_invoice', description: 'Create a new invoice', source: 'bill' },
    { tool: 'bill_create_invoice_from_time', description: 'Generate an invoice from logged time entries', source: 'bill' },
    { tool: 'bill_create_invoice_from_deal', description: 'Generate an invoice from a Bond deal', source: 'bill' },
    { tool: 'bill_add_line_item', description: 'Add a line item to an invoice', source: 'bill' },
    { tool: 'bill_finalize_invoice', description: 'Finalize a draft invoice and lock it', source: 'bill' },
    { tool: 'bill_send_invoice', description: 'Send a finalized invoice to the customer', source: 'bill' },
    { tool: 'bill_record_payment', description: 'Record a payment against an invoice', source: 'bill' },
    { tool: 'bill_create_expense', description: 'Create a new expense record', source: 'bill' },

    // -------- Book (calendar) --------
    { tool: 'book_create_event', description: 'Create a new calendar event', source: 'book' },
    { tool: 'book_update_event', description: 'Update an existing calendar event', source: 'book' },
    { tool: 'book_cancel_event', description: 'Cancel a calendar event', source: 'book' },
    { tool: 'book_find_meeting_time', description: 'Find an available meeting time across multiple attendees', source: 'book' },
    { tool: 'book_create_booking_page', description: 'Create a public booking page', source: 'book' },
    { tool: 'book_rsvp_event', description: 'Record an RSVP response on a calendar event', source: 'book' },

    // -------- Blank (form builder) --------
    { tool: 'blank_create_form', description: 'Create a new form', source: 'blank' },
    { tool: 'blank_generate_form', description: 'AI-generate a form from a natural-language prompt', source: 'blank' },
    { tool: 'blank_update_form', description: 'Update an existing form', source: 'blank' },
    { tool: 'blank_publish_form', description: 'Publish a form to make it available for submissions', source: 'blank' },
    { tool: 'blank_export_submissions', description: 'Export form submissions as CSV', source: 'blank' },

    // -------- Bench (analytics) --------
    { tool: 'bench_query_widget', description: 'Execute a dashboard widget query and return results', source: 'bench' },
    { tool: 'bench_query_ad_hoc', description: 'Execute an ad-hoc analytics query', source: 'bench' },
    { tool: 'bench_summarize_dashboard', description: 'Generate a natural-language summary of a dashboard', source: 'bench' },
    { tool: 'bench_detect_anomalies', description: 'Detect anomalies in a time-series metric', source: 'bench' },
    { tool: 'bench_generate_report', description: 'Generate a scheduled report from a dashboard', source: 'bench' },
    { tool: 'bench_compare_periods', description: 'Compare a metric across two time periods', source: 'bench' },
