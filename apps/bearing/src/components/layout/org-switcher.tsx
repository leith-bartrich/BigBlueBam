...
/**
 * Bearing port of the OrgSwitcher. Calls the Bam auth API (shared session)
 ...
 * invalidates all React Query caches, and reloads to /bearing/ so the new
