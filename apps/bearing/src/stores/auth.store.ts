...
export const useAuthStore = create<AuthState>((set) => ({
  ...
  fetchMe: async () => {
    try {
      // Use the Bam auth endpoint since Bearing shares the same session
...
(globalThis as any).__bearingAuthStore = useAuthStore;
