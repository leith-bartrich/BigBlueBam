          ...
          <div className="rounded-xl border border-primary-200 bg-gradient-to-br from-primary-50 to-white p-6 shadow-sm">
            <div className="mb-3 flex items-center gap-3">
              ...
              <div>
                ...
                <Badge variant="blue">182 tools</Badge>
              </div>
            </div>
            <p className="mb-4 text-sm text-zinc-600">
              A full Model Context Protocol server exposes every action across BigBlueBam, Beacon,
              Brief, Bolt, Bearing, Banter, and the Helpdesk to AI agents. Manage projects, search knowledge, automate workflows, track goals, message your
